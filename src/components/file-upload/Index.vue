    ...
    >
      ...
      <div v-if="selectedFiles.length > 0" style="margin-top: 20px">
        <div class="file-upload-list-file">
          <div v-for="(file, index) in selectedFiles" :key="index" class="file-upload-preview-file" style="margin-bottom: 10px">
            <img
            ...
            <button class="remove-file-upload-button" @click="handleRemoveFile(file, $event)" style="margin-left: 10px; color: red">
