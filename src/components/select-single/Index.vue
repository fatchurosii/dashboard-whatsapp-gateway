<template>
    ...
    <div
      ...
      <div class="d-flex" style="margin-left: 10px">
        <div v-if="notEmptyObject(modelValue) && clearable && !disabled" class="select-single-remove-icon" @click="handleRemoveValue">
    ...
    <div v-if="isDropdownOpen" class="select-single-option">
      <div v-if="searchable" class="select-single-option-search" style="border-bottom: 1px solid #e5e5e5;display: flex;align-items: center;">
        <div>
...
.vue-select-single-energeek .select-single-option-list a:hover, .vue-select-single-energeek .select-single-option-list a.active{
